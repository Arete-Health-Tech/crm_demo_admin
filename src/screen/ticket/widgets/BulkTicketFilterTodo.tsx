...
import {
  selectedBulkFiltersReducerFollowUp,
  selectedBulkFiltersReducerTodo,
  selectedFiltersReducer,
  ticketFilterTypes
} from '../ticketStateReducers/filter';
import { bulkFilterActionsTodo } from '../ticketStateReducers/actions/filterAction';
import {
...
const BulkTicketFilterTodo = (props: {
  ...
  const [selectedFilters, dispatchBulkFilterTodo] = useReducer(
    selectedBulkFiltersReducerTodo,
    initialFilters
  );
  ...
  const handleStageList = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //   dispatchBulkFilterTodo({
    //     type: bulkFilterActionsTodo.STAGES,
  ...
  const handleRepresentative = (e: any) => {
    ...
    if (value) {
      ...
      dispatchBulkFilterTodo({
        type: bulkFilterActionsTodo.REPRESENTATIVE,
        payload: value
      });
    }
  };
  ...
  const handleAdmissionType = (
    ...
    dispatchBulkFilterTodo({
      type: bulkFilterActionsTodo.ADMISSIONTYPE,
  ...
  const handleStatusType = (
    ...
    dispatchBulkFilterTodo({
      type: bulkFilterActionsTodo.STATUS,
      payload: Status
    });
  };
  ...
  const handleDiagnosticsType = (
    ...
    dispatchBulkFilterTodo({
      type: bulkFilterActionsTodo.DIAGNOSTICSTYPE,
  ...
  const handleStartDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    dispatchBulkFilterTodo({
      type: bulkFilterActionsTodo.DATERANGE,
  ...
  const handleFollowUp = (
    ...
    if (followUp == null) {
      ...
      dispatchBulkFilterTodo({
        type: bulkFilterActionsTodo.FOLLOWUP,
  ...
  const handleResult = (e: any) => {
    ...
    if (value === 'Won') {
      setResult(value);
      dispatchBulkFilterTodo({
        type: bulkFilterActionsTodo.RESULTS,
  ...
  const handleApplyFilter = async () => {
    ...
    setBulkPageNumber(1);
    setBulkFilterTicketsTodo(selectedFilters);
...
export default BulkTicketFilterTodo;

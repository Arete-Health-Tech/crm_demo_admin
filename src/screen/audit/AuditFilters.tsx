...
import {
  ...
  ticketFilterTypes
} from '../ticket/ticketStateReducers/filter';
...
const AuditFilters = (props: {
  ...
  const [selectedReperesentativeName, setSelectedRepresentativeName] =
    useState('');
  ...
  return (
    <>
      ...
      <Stack className={styles.Audit_stage_filter}>
        <Stack
          className={styles.Audit_filters}
          onClick={() => {
        ...
        >
          ...
          <span className={styles.Audit_filters_icon}>
      ...
      <Stack className={styles.Audit_stage_filter}>
        ...
        >
          <span
            className={styles.Audit_filters_title}
        ...
        >
          ...
          <MenuItem
            sx={menuItemStyles}
            onClick={() => {
              handleStatusChange('pendingTask');
            }}
          >
            Pending
          </MenuItem>
          <MenuItem
            sx={menuItemStyles}
            onClick={() => {
              handleStatusChange('CallCompleted');
            }}
          >
            Call Completed
          </MenuItem>

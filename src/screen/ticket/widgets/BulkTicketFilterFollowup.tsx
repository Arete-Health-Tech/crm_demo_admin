...
import { bulkFilterActionsFollowUp } from '../ticketStateReducers/actions/filterAction';
import {
...
const BulkTicketFilterFollowup = (props: {
  ...
  const [selectedFilters, dispatchBulkFilterFollowup] = useReducer(
    selectedBulkFiltersReducerFollowUp,
    initialFilters
  );
...
export default BulkTicketFilterFollowup;
